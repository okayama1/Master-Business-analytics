 ...
 \begin{column}{0.5\textwidth}
  \begin{block}{}
   \begin{enumerate}
    ...
    \item[\faArrowRight] Median salary USD114K
   \end{enumerate}
  \end{block}
 \end{column}
\end{columns}
...
\vspace{-0.3cm}
 \begin{itemize}\tightlist
  ...
  \item  Fiercely independent, not sponsored by any software company only use open-source software.
 \end{itemize}  
...
\begin{block}{(A) Advanced preparatory studies (24 points)}
 \begin{itemize}
...
\begin{block}{(B) Mastery knowledge (48 points)}
 \begin{itemize}
...
\begin{block}{(C) Application studies (24 points)}
 \begin{itemize}
